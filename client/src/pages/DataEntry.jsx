...
// src/pages/DataEntry.jsx - FINAL MERGED VERSION
...
//     // Multi-select options for sons and daughters
...
//             />
//             <p className="text-xs text-gray-400 mt-1">
//               💡 म्यानुअल रूपमा प्रविष्ट गर्नुहोस् वा अवस्थित मध्येबाट छान्नुहोस्। डुप्लिकेट अनुमति छ।
//             </p>
//           </div>
...
// src/pages/DataEntry.jsx - COMPLETE FIXED VERSION (rollNumber removed)
...
const DataEntry = ({ member, onSuccess, onCancel }) => {
  ...
  // ⭐ NEW: Fetch family-specific Bansha numbers when family changes
  ...
  const handleSelectChange = (name, value) => {
    ...
    // ⭐ NEW: Handle marital status change - show/hide wife fields
    if (name === 'maritalStatus') {
      setFormData((prev) => ({
        ...prev,
        [name]: value || '',
        // Reset wife fields if not married
  ...
  // ⭐ UPDATED: Personal Info with Wife section
  const renderPersonalInfo = () => (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
      <div className="md:col-span-2 space-y-3">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          ...
          {/* ⭐ NEW: Wife section - shown only when Married */}
          {formData.maritalStatus === 'married' && (
            <div className="md:col-span-2 p-4 bg-pink-50 rounded-xl border border-pink-200">
              <h4 className="text-sm font-medium text-pink-700 mb-3 flex items-center gap-2">
                ...
                श्रीमतीको विवरण (Spouse Information)
              </h4>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                <FloatingInput
                  label="श्रीमतीको नाम (Wife Name)"
                  name="wifeName"
                  value={formData.wifeName}
                  onChange={handleChange}
                  placeholder="श्रीमतीको पूरा नाम"
                  icon={FaUser}
                />
                <NepaliDatePickerComponent
                  label="श्रीमतीको जन्म मिति (Wife DOB)"
                  name="wifeDob"
                  value={formData.wifeDob}
                  onChange={handleSelectChange}
                  placeholder="श्रीमतीको जन्म मिति"
                />
              </div>
              <p className="text-xs text-gray-500 mt-2">
                💡 श्रीमतीको विवरण ट्रीमा मात्र देखाइनेछ, मेम्बर लिस्टमा देखाइने छैन।
              </p>
            </div>
          )}
  ...
  // ⭐ UPDATED: Family Info - removed rollNumber, added houseIdentifier
  const renderFamilyInfo = () => {
    const maleMembers = (membersData?.data || []).filter(m => m.gender === 'male');
    const femaleMembers = (membersData?.data || []).filter(m => m.gender === 'female');
    const allMembers = membersData?.data || [];
    ...
    return (
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          ...
          {/* ❌ REMOVED: Roll Number field - completely removed */}
          ...
          <div className="md:col-span-2">
            <VanshNoAutocomplete
              ...
              onChange={handleSelectChange}
              placeholder="खोज्नुहोस् वा नयाँ वंश नं. प्रविष्ट गर्नुहोस्..."
              familyId={formData.family} // ⭐ Pass family for filtering
              required={false}
            />
            <p className="text-xs text-gray-400 mt-1">
...
// // src/pages/DataEntry.jsx - COMPLETE UPDATED FILE
...
// import NepaliDatePickerComponent from '../components/NepaliDatePickerComponent';
// import Button from '../components/Button';
// import VanshNoAutocomplete from '../components/VanshNoAutocomplete'; // ⭐ ADDED: Import VanshNoAutocomplete
...
//   // ⭐ UPDATED: initialFormData with manual vanshaGenerationNumber
//   const initialFormData = {
//     name: '',
//     surname: '',
//     gender: 'male',
...
//     familyNumber: '',
//     rollNumber: '',
//     vanshaGenerationNumber: '', // ⭐ Manual input - changed from auto-generated
//     generation: 1,
//     relationship: 'member',
//     father: '',
//     mother: '',
...
//   // validateForm - Family IS required for saving
//   const validateForm = () => {
//     const errors = {};
...
//   // ⭐ UPDATED: renderPersonalInfo with Date of Death
//   const renderPersonalInfo = () => (
//     <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
//       <div className="md:col-span-2 space-y-3">
//         <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
...
//             </label>
//           </div>
//           {/* ⭐ NEW: Date of Death - only show when not alive */}
//           {!formData.isAlive && (
//             <div className="md:col-span-2">
//               <NepaliDatePickerComponent
//                 label="मृत्यु मिति (Date of Death)"
...
//   // ⭐ UPDATED: renderFamilyInfo with VanshNoAutocomplete
//   const renderFamilyInfo = () => {
//     const maleMembers = (membersData?.data || []).filter(m => m.gender === 'male');
//     const femaleMembers = (membersData?.data || []).filter(m => m.gender === 'female');
//     const allMembers = membersData?.data || [];
...
//           {/* ⭐ NEW: Vansh No. with Autocomplete */}
//           <div className="md:col-span-2">
//             <VanshNoAutocomplete
//               label="वंश नं. (Vansh No.)"
//               name="vanshaGenerationNumber"
